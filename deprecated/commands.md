...
This document preserves the old client-command system after it was deprecated from the live UI.
It is archived for reference while a replacement command UX is implemented.
